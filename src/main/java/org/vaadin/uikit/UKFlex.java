...
public class UKFlex extends Div implements UKMargin, UKWidthAndHeight, UKPadding {
	...
	public enum VerticalAlignment {
		STRETCH("uk-flex-stretch"), TOP("uk-flex-top"), MIDDLE("uk-flex-middle"), BOTTOM("uk-flex-bottom");
	...
	public enum Direction {
		ROW("uk-flex-row"), ROW_REVERSE("uk-flex-row-reverse"), COLUMN("uk-flex-column"),
	...
	public enum WrapBehavior {
		WRAP("uk-flex-wrap"), WRAP_REVERSE("uk-flex-wrap-reverse"), NOWRAP("uk-flex-nowrap");
	...
	public enum WrapModifier {
		STRETCH("uk-flex-wrap-stretch"), BETWEEN("uk-flex-wrap-between"), AROUND("uk-flex-wrap-around"),
		TOP("uk-flex-wrap-top"), MIDDLE("uk-flex-wrap-middle"), BOTTOM("uk-flex-wrap-bottom");
	...
	public void setWrapModifier(WrapModifier wrapModifier) {
		if (!getClassNames().contains(WrapBehavior.WRAP.getWrapBehavior())
				&& !getClassNames().contains(WrapBehavior.WRAP_REVERSE.getWrapBehavior())) {
			if (getClassNames().contains(WrapBehavior.NOWRAP.getWrapBehavior())) {
				throw new IllegalStateException("Cannot set wrap modifier when using WrapBehavior.NOWRAP");
			} else {
